...
interface HoveringToolbarButtonProps
...
const HoveringToolbarButton = (props: HoveringToolbarButtonProps) => {
  const {
    icon: Icon,
    onClick,
    text,
  ...
  return (
    <Tooltip content={tooltip} placement="top" disabled={!tooltip}>
      <button onClick={onClick} className={buttonClassName} {...otherProps}>
        <Icon size={18} />
        {text ? (
